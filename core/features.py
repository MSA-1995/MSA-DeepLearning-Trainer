...
def extract_features(trade, symbol_memory):
    ...
    """
    # Extract features from trade data and symbol memory
    symbol = trade.get('symbol', '')
    sym_data = symbol_memory.get(symbol, {})

    # Helper to get numeric value, default to 0, convert to float
    ...
    fear_greed_norm = fear_greed / 100
    is_fearful = 1 if fear_greed < 40 else 0
    is_greedy = 1 if fear_greed > 60 else 0
