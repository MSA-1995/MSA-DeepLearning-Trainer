...
_env_loaded = False
for _env_file in [
    os.path.join(_script_dir, '.env'), # Local .env file (core/)
    os.path.join(os.path.dirname(_script_dir), '.env'), # Parent directory (MSA-DeepLearning-Trainer/)
...
if not os.getenv('ENCRYPTION_KEY'):
    ...
    # استخدام مسار نسبي أو متغير بيئة بدلاً من المسار المطلق
